...
FloorFilter::FloorFilter() :
    height_clip_range_(2.5), floor_min_points_num_(1000),
    point_normal_threshhold_(20), floor_normal_threshhold_(20) { }
                         ...
                         pcl::PointCloud<pcl::PointXYZI>::Ptr& floor_cloud)
{
  ...
  pcl::PointCloud<pcl::PointXYZI>::Ptr horizontal_cloud(
